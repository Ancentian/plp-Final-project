...
const UploadProduct = ({
  ...
  const [fullScreenImage,setFullScreenImage] = useState("")
    ...
    const handleSubmit = async(e) => {
      e.preventDefault()
      console.log("dataTest", SummaryApi.uploadProduct.url)
        ...
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
          ...
          <form className='grid p-2 gap-3 overflow-y-scroll h-full' onSubmit={handleSubmit}>
            ...
            <label htmlFor='sellingPrice' className='mt-3'>Selling Price :</label>
                    ...
                    <button className='px-2 py-1 bg-red-600 text-white rounded mb-10 hover:bg-red-700' type='submit'>Upload Product</button>
          </form>
